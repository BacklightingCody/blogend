...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var data, _a, _b, _i, _c, user, _d, _e, post, _f, _g, comment, error_1;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    _h.trys.push([0, 15, 16, 18]);
                    _b = (_a = JSON).parse;
                    return [4 /*yield*/, fs.readFile('data.json', 'utf-8')];
                case 1:
                    data = _b.apply(_a, [_h.sent()]);
                    if (!data.users) return [3 /*break*/, 6];
                    _i = 0, _c = data.users;
                    _h.label = 2;
                case 2:
                ...
                case 10:
                    ...
                    if (!data.comments) return [3 /*break*/, 14];
                    _f = 0, _g = data.comments;
                    _h.label = 11;
                case 11:
